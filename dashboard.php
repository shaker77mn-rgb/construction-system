...
<div class="lg:mr-64 p-6 min-h-screen bg-gray-100">
    ...
    <!-- Page Header -->
    <div class="mb-8">
        <h1 class="text-3xl font-semibold text-gray-800">لوحة التحكم</h1>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6 mb-10">
        ...
        statCard("عناصر المخزون المنخفض", $low_stock, "fa-exclamation-triangle", "bg-orange-100", "text-orange-600");
        ?>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
        ...
        <!-- Low Stock Items -->
        <div class="bg-white rounded-2xl shadow-md p-6">
            <h2 class="text-lg font-semibold text-gray-700 mb-4">عناصر المخزون المنخفض</h2>
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-right">
                    <thead class="bg-gray-100 text-gray-600 uppercase text-xs">
                        <tr>
