...
<body class="min-h-screen flex items-center justify-center font-inter relative">
    ...
    <div class="relative w-full max-w-md px-6 animate-fadeIn">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="username" required
                               class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-accent outline-none transition">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="password" id="password" required
                               class="w-full pl-10 pr-10 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-accent outline-none transition">
        ...
        <p class="text-center text-gray-300 text-xs mt-6">
            © <?php echo date("Y"); ?> Construction Management System
        </p>
